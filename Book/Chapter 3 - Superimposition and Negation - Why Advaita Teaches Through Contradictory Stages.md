...
**Pedagogical Function:** This theory meets the student where they are—in a world experienced as solidly real, with causal relationships that appear self-evident. It acknowledges the vyāvahārika (empirical) reality while introducing the crucial concept of essential unity between cause and effect. The world is not other than Brahman even if it appears modified. Just as yogurt is genuinely different from milk—with altered taste, texture, and properties—yet both share the same essential substance (dairy), so too the world is seen as a real modification of Brahman's substance.

**Psychological Parallel:** In developmental terms, this corresponds to concrete operational thinking (Piaget)—the world operates through observable cause-effect relationships. In psychotherapy, this is the level at which most therapeutic work begins: acknowledging the reality of the client's experience before introducing alternative perspectives. The trauma therapist doesn't begin by telling the PTSD patient their memories are illusory; she validates the reality of their experience before helping them transform their relationship to it.

**Critical Limitation:** The obvious philosophical problem—how can the immutable Brahman undergo modification without compromising its eternality and perfection? If Brahman truly transforms, it implies limitation, temporality, and dependence on conditions. The yogurt is genuinely not milk; something has actually changed, acquired new properties, become something it wasn't before. This real transformation contradicts Brahman's immutable nature. This contradiction prepares the ground for the next stage. Gauḍapādā in the Māṇḍūkya Karika raises these objections in the following verse:

_Verse 2.20: The disputants (i.e., the dualists) contend that the ever-unborn (changeless) entity (Ātman) undergoes a change. How could an entity which is changeless and immortal partake of the nature of the mortal?_
...
More fundamentally, introducing a second, independently real principle does not explain transformation—it merely displaces it. The difficulty of interaction between the changeless and the changing is not resolved but postponed. How do two eternally distinct realities ever come into relation at all? Mere proximity cannot account for activity unless one of the two already possesses the power to act, which would contradict its supposed inertness or changelessness.

For Advaita, this is precisely why pariṇāmavāda is retained only as a provisional teaching. Any attempt to preserve real transformation—whether by attributing it directly to Brahman or by outsourcing it to a second principle—ultimately collapses. The theory functions pedagogically, not ontologically. Its purpose is to meet the seeker at the level where the world is still taken as unquestionably real, before that assumption itself becomes the object of inquiry.

### 3.2. Stage 2: Pratibimbavāda: Explaining the Appearance of the Individual Self
